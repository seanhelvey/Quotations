...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field quotes on 'Subject'
        m2m_table_name = db.shorten_name(u'quotations_subject_quotes')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field quotes on 'Subject'
        db.delete_table(db.shorten_name(u'quotations_subject_quotes'))
    ...
    models = {
        ...
        u'quotations.subject': {
            ...
            'quotes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['quotations.Quote']", 'symmetrical': 'False'})
        }
    }
